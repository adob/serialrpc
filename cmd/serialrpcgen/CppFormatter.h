...
namespace application
{
    ...
    public:
        ...
        void Parameter(const std::string& parameter, const std::string& init = "");

        void PrintHeader(google::protobuf::io::Printer& printer) const override;
        void PrintSource(google::protobuf::io::Printer& printer, const std::string& scope) const override;

    private:
        std::string HeaderParameters() const;
        std::string SourceParameters() const;
    ...
    {
    public:
        explicit StructForwardDeclaration(const std::string& name);
    ...
    {
    public:
        explicit EnumDeclaration(const std::string& name, const std::vector<std::pair<std::string, int>>& members, bool scoped = false);
