...
namespace application
{
    ...
    class EchoFieldFloat
        : public EchoField
    {
    public:
        explicit EchoFieldFloat(const google::protobuf::FieldDescriptor& descriptor);

        void Accept(EchoFieldVisitor& visitor) const override;
    };

    class EchoFieldDouble
        : public EchoField
    {
    public:
        explicit EchoFieldDouble(const google::protobuf::FieldDescriptor& descriptor);
    ...
    public:
        ...
        virtual void VisitFloat(const EchoFieldFloat& field) = 0;
        virtual void VisitDouble(const EchoFieldDouble& field) = 0;
