...
static std::string UnderscoresToCamelCase(absl::string_view input, bool cap_next_letter) {
    std::string result;
...
static std::string FieldConstantName(const google::protobuf::FieldDescriptor *field) {
    std::string field_name = UnderscoresToCamelCase(field->name(), true);
    std::string result = absl::StrCat(field_name, "FieldNumber");
...
namespace application
{
    ...
    EchoField::EchoField(const std::string& protoType, const google::protobuf::FieldDescriptor& descriptor)
        ...
        , constantName(FieldConstantName(&descriptor))
        , type(descriptor.type())
    {}

    std::shared_ptr<EchoField> EchoField::GenerateField(const google::protobuf::FieldDescriptor& fieldDescriptor, EchoRoot& root)
    {
        //bool optional = fieldDescriptor.has_optional_keyword();
        google::protobuf::FieldDescriptorProto proto;
        fieldDescriptor.CopyTo(&proto);
        //bool optional = !fieldDescriptor.is_required() && !fieldDescriptor.is_repeated() && !fieldDescriptor.containing_oneof();
        bool optional = proto.has_proto3_optional();
        if (optional)
            switch (fieldDescriptor.type())
            {
                ...
                case google::protobuf::FieldDescriptor::TYPE_FLOAT:
                    return std::make_shared<EchoFieldOptional>(fieldDescriptor, std::make_shared<EchoFieldFloat>(fieldDescriptor));
                case google::protobuf::FieldDescriptor::TYPE_DOUBLE:
                    return std::make_shared<EchoFieldOptional>(fieldDescriptor, std::make_shared<EchoFieldDouble>(fieldDescriptor));
                default:
            ...
            switch (fieldDescriptor.type())
            {
                ...
                case google::protobuf::FieldDescriptor::TYPE_FLOAT:
                    return std::make_shared<EchoFieldFloat>(fieldDescriptor);
                case google::protobuf::FieldDescriptor::TYPE_DOUBLE:
                    return std::make_shared<EchoFieldDouble>(fieldDescriptor);
                default:
                    throw UnsupportedFieldType{ std::string(fieldDescriptor.name()), fieldDescriptor.type() };
            }
            ...
            switch (fieldDescriptor.type())
            {
                ...
                case google::protobuf::FieldDescriptor::TYPE_FLOAT:
                    return std::make_shared<EchoFieldRepeated>(fieldDescriptor, std::make_shared<EchoFieldFloat>(fieldDescriptor));
                case google::protobuf::FieldDescriptor::TYPE_DOUBLE:
                    return std::make_shared<EchoFieldRepeated>(fieldDescriptor, std::make_shared<EchoFieldDouble>(fieldDescriptor));
                default:
                    throw UnsupportedFieldType{ std::string(fieldDescriptor.name()), fieldDescriptor.type() };
            }
        else
            switch (fieldDescriptor.type())
            {
                ...
                case google::protobuf::FieldDescriptor::TYPE_FLOAT:
                    return std::make_shared<EchoFieldUnboundedRepeated>(fieldDescriptor, std::make_shared<EchoFieldFloat>(fieldDescriptor));
                case google::protobuf::FieldDescriptor::TYPE_DOUBLE:
                    return std::make_shared<EchoFieldUnboundedRepeated>(fieldDescriptor, std::make_shared<EchoFieldDouble>(fieldDescriptor));
                default:
                    throw UnsupportedFieldType{ std::string(fieldDescriptor.name()), fieldDescriptor.type() };
            }
    }
        ...
        , maxStringSize(descriptor.options().GetExtension(string_size))
    {
        ...
        protoReferenceType = protoType = "services::ProtoString<" + SimpleItoa(maxStringSize) + ">";
    }
        ...
        , maxBytesSize(descriptor.options().GetExtension(bytes_size))
    {
        ...
        protoReferenceType = protoType = "services::ProtoBytes<" + SimpleItoa(maxBytesSize) + ">";
    }
    ...
    EchoFieldFloat::EchoFieldFloat(const google::protobuf::FieldDescriptor& descriptor)
        : EchoField("services::ProtoFloat", descriptor)
    {}

    void EchoFieldFloat::Accept(EchoFieldVisitor& visitor) const
    {
        visitor.VisitFloat(*this);
    }

    EchoFieldDouble::EchoFieldDouble(const google::protobuf::FieldDescriptor& descriptor)
        : EchoField("services::ProtoDouble", descriptor)
    {}

    void EchoFieldDouble::Accept(EchoFieldVisitor& visitor) const
    {
        ...
        , type(type)
    {
        ...
        protoType = "services::ProtoRepeated<" + SimpleItoa(maxArraySize) + ", " + type->protoType + ">";
        protoReferenceType = "services::ProtoRepeated<" + SimpleItoa(maxArraySize) + ", " + type->protoReferenceType + ">";
    }
    ...
    EchoFile::EchoFile(const google::protobuf::FileDescriptor& file, EchoRoot& root)
    {
        ...
        if (!packageParts.empty()) {
            packageParts[packageParts.size()-1] += "pb";
        }

        for (int i = 0; i != file.dependency_count(); ++i)
            if (file.dependency(i)->name() != std::string_view("serialrpc.proto"))
    ...
    void EchoRoot::AddDescriptorSet(const google::protobuf::FileDescriptorSet& descriptorSet)
    {
        ...
        for (int i = 0; i != descriptorSet.file_size(); ++i)
        {
            ...
            // assert(file != NULL, AssertionFailed);
